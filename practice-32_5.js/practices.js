...
const mystring = `${myNumber} is really not my favorite number . But ${
  anotherNumber / 2
} is a good number`;
...
// console.log(divider(30), '  It divides the number by 5');
...
const calcTheThree = (a, b, c) => a * b * c;

// console.log(calcTheThree(2,3,4))
...
const fiveTimedArray = firstArray.map((number) => number * 5);

console.log(fiveTimedArray);
...
const oddEvenArray = [1, 2, 3, 4, 5, 6, 7, 8];

const oddOnes = oddEvenArray.filter((num) => num % 2 != 0);
